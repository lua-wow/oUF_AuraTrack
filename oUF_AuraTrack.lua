...
if oUF.isRetail then
	Tracker = {
		...
		[81782]   = {0, 0, 0.74}, -- Power World: Barrier

		-- DRUID
		[774]     = {0.8, 0.4, 0.8}, -- Rejuvenation
		[155777]  = {0.8, 0.4, 0.8}, -- Rejuvenation (Germination)
		[8936]    = {1, 1, 0}, -- Regrowth
		...
		[102342]  = {0.2, 0.8, 0.8}, -- Ironbark
		[200389]  = {1, 1, 0.4}, -- Cultivation
		[391891]  = {1, 1, 0.4}, -- Adaptive Swarm
		[157982]  = {1, 1, 1}, -- Tranquility
		...
		[204018]  = {0.7, 0.7, 0.3}, -- Blessing of Spellwarding
